 ...
 * 
 */
public class AproxFunUI extends JPanel implements ActionListener,
		ChangeListener {

	/** */
	private static final long serialVersionUID = 714904529268363806L;

	private static final String strMetodos[] = { "Polinomio Simple",
	...
	private void initComponents() {
		...
		scpTable.setBorder(javax.swing.BorderFactory
				.createTitledBorder("Tabla Tabulada"));

		pnlMetodos = new JPanel(new GridBagLayout());
		pnlMetodos.setBorder(javax.swing.BorderFactory
				.createTitledBorder("M�todos de aproximaci�n"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		lblPolinomio.setText("<html>Polinomio aproximado: " + f.getSpecific()
				+ "</html>");
