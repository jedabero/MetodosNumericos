...
public class MonomioPanel extends JPanel implements Editors {
	...
	/**
	 * Crea un panel para editar un termino tipo polinomico.
	 * Por deafult el grado es 1 y el coeficiente es 0.
	 */
	public MonomioPanel() {
		this(1);
	}
	...
	/**
	 * Crea un panel para editar un termino tipo polinomico de grado g.
	 * Por deafult el coeficiente es 0.
	 * @param g grado del termino
	 */
	...
	/**
	 * Crea un panel para editar un termino tipo polinomico de grado g y coeficiente a
	 * 
	 * @param g grado del termino
	 * @param a coeficiente
	 */
	...
	public void addComponents() {
		Add.componente(this, new JLabel("Grado:",JLabel.CENTER),
				0, 0, 1, 1, 0.0, 1.0, GridBagConstraints.NONE, "");
		Add.componente(this, spnrGrado,
				1, 0, 2, 1, 1.0, 1.0, GridBagConstraints.BOTH, "");
