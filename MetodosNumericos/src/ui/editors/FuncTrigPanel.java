...
public class FuncTrigPanel extends JPanel implements Editors {
	...
	public void init() {
		...
		cpB = new CoeficientePanel("<html>B"
				+ (index >= 0 ? ("<sub>" + index + "</sub>") : "")
				+ "= </html>");
	...
	public void addComponents() {
		Add.componente(this, new JLabel("Funcion:", JLabel.CENTER), 0, 0, 1, 1,
				1.0, 1.0, GridBagConstraints.NONE, "");
		Add.componente(this, listaTipoTrig, 1, 0, 3, 1, 1.0, 1.0,
				GridBagConstraints.BOTH, "");
		Add.componente(this, cpA, 0, 1, 2, 1, 1.0, 1.0,
				GridBagConstraints.BOTH, "Coeficiente A");
		Add.componente(this, cpB, 2, 1, 2, 1, 1.0, 1.0,
				GridBagConstraints.BOTH, "Coeficiente B");
	}
	...
	public Termino getTermino() {
		...
		try {
			...
			String msgstr = "<html>Coeficiente B"
					+ (index >= 0 ? ("<sub>" + index + "</sub>") : "") + ": "
		...
		termino = (coefB == null || coefA == null) ? null : Termino
				.trigonometrico(tipoTrig, coefA, coefB, null);
