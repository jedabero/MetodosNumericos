...
public class MetodosMatrices extends javax.swing.JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1497804356298952577L;
	...
	public MetodosMatrices() {
		...
		dtmMatriz = new javax.swing.table.DefaultTableModel(matrizTabla,
				tableHeaders);
	...
	private void initComponents() {
		...
		tablaMatriz = new javax.swing.JTable() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -8151131466243359028L;
		...
		lblNumIncog.setText("Numero de incognitas:");
		...
		spnIter.setModel(new javax.swing.SpinnerNumberModel(
				Integer.valueOf(15), Integer.valueOf(5), null, Integer
						.valueOf(1)));
	...
	private void spnrNumEcStateChanged(javax.swing.event.ChangeEvent evt) {
		...
		numEc = Integer.parseInt(((javax.swing.JSpinner) evt.getSource())
				.getValue().toString());
	...
	private void spnrNumInStateChanged(javax.swing.event.ChangeEvent evt) {
		numInc = Integer.parseInt(((javax.swing.JSpinner) evt.getSource())
				.getValue().toString());
		O.pln("Numero de incognitas:" + numInc);
		if (numInc > numEc) {
			JOptionPane.showMessageDialog(this,
					"No hay soluci�n si hay m�s incognitas que ecuaciones.");
			spnrNumIn.setValue(spnrNumEc.getValue());
		}
		resetTable(numInc + 1, numEc);
	}

	private void btnGaussActionPerformed(java.awt.event.ActionEvent evt) {
		creaMatriz();
		mostrarTabla(sel.metodoGauss().getMatriz(), dtmMetodo, tableHeaders,
				tablaResAn);
	}

	private void btnJordanActionPerformed(java.awt.event.ActionEvent evt) {
		creaMatriz();
		mostrarTabla(sel.metodoJordan().getMatriz(), dtmRes, tableHeaders,
				tablaResAn);
	}

	private void btnJacobiActionPerformed(java.awt.event.ActionEvent evt) {
		creaMatriz();
		try {
	...
	private void btnSeidelActionPerformed(java.awt.event.ActionEvent evt) {
		creaMatriz();
		try {
			int it = Integer.parseInt(spnIter.getValue().toString());
			tol = new BigDecimal(txtTol.getText());
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(MetodosMatrices.class.getName())
	...
	private String resTableHeaders[] = { "<html>x<sub>i</sub></html>",
