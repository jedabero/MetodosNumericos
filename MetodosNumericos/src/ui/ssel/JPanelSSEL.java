...
public class JPanelSSEL extends javax.swing.JPanel {
	 ...
	 */
	public JPanelSSEL() {
		tblIterHeaders = new String[] { "<html>x<sub>i</sub></html>",
				"<html>e<sub>i</sub></html>" };

		resetTableHeaders();

		mainMatriz = new BigDecimal[numEc][numEc + 1];
		dtmSistema = new javax.swing.table.DefaultTableModel(mainMatriz,
				tblSistHeaders);

		dtmAnal = new javax.swing.table.DefaultTableModel(mainMatriz,
				tblSistHeaders);

		dtmIter = new javax.swing.table.DefaultTableModel(
				new BigDecimal[numEc][2], tblIterHeaders);
	...
	private void initComponents() {
		...
		pnlAnalitico.setBorder(javax.swing.BorderFactory
				.createTitledBorder("M�todos Anal�ticos"));
		...
		javax.swing.GroupLayout pnlAnaliticoLayout = new javax.swing.GroupLayout(
				pnlAnalitico);
		pnlAnalitico.setLayout(pnlAnaliticoLayout);
		pnlAnaliticoLayout
				.setHorizontalGroup(pnlAnaliticoLayout
						.createParallelGroup(
						...
						.addGroup(
								pnlAnaliticoLayout
										...
										.addContainerGap()));
		pnlAnaliticoLayout
				.setVerticalGroup(pnlAnaliticoLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								pnlAnaliticoLayout
		...
		jLabel1.setText("N�mero de ecuaciones:");
		...
		javax.swing.GroupLayout pnlSistemaLayout = new javax.swing.GroupLayout(
				pnlSistema);
		pnlSistema.setLayout(pnlSistemaLayout);
		pnlSistemaLayout
				.setHorizontalGroup(pnlSistemaLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								pnlSistemaLayout
										...
										.addContainerGap()));
		pnlSistemaLayout
				.setVerticalGroup(pnlSistemaLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								pnlSistemaLayout
		...
		spnIt.setModel(new javax.swing.SpinnerNumberModel(Integer.valueOf(15),
				Integer.valueOf(5), null, Integer.valueOf(1)));
	...
	private void spnNumEcStateChanged(javax.swing.event.ChangeEvent evt) {// GEN-FIRST:event_spnNumEcStateChanged
		int n = Integer.parseInt(((javax.swing.JSpinner) evt.getSource())
				.getValue().toString());
		resetTable(n);
		numEc = n;
		resetTableHeaders();
	...
	private void btnJordanActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnJordanActionPerformed
		creaMatriz();
		dtmAnal.setDataVector(mainSel.metodoJordan().getMatriz(),
				tblSistHeaders);
	...
	private void btnJacobiActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnJacobiActionPerformed
		...
		if (!mainSel.getMatrizCoef().esEstrictamenteDiagonalDominante()) {
			JOptionPane.showMessageDialog(this.getParent(), "El m�todo "
					+ "posiblemente no converger� porque la matriz no es "
					+ "estrictamente diagonal dominante.", "Advertencia",
		...
		for (int i = 0; i < numEc; i++) {
			for (int j = 0; j < numEc + 1; j++) {
				...
				try {
					...
					String varerr = ((j < numEc) ? "x<sub>" + (j + 1)
							+ "</sub>" : "b");
					JOptionPane.showMessageDialog(this, "<html>Ecuaci�n "
							+ (i + 1) + ", " + varerr + " : " + v + "</html>",
	...
	private void checkIterErrors() {
		...
		try {
			...
			toltext += (toltext.isEmpty()) ? "Vac�o" : "";
			JOptionPane.showMessageDialog(this.getParent(), toltext
					+ " es inv�lido.", "Error en el valor de la Toleracia",
