 ...
 * @author Jedabero
 */
public class MatricesJApplet extends Applet implements ChangeListener,
	...
	private void initComponents() {
		...
		nCols = 3;
		nRows = 3;
		dtmMatriz = new javax.swing.table.DefaultTableModel(new Object[][] {
				{ 1, 1, 1 }, { 1, 1, 1 }, { 1, 1, 1 } }, new String[] { "1",
				"2", "3" });
		...
		itemsElem = new String[] { "Determinante", "Traza", "Cofactor en...",
				"Reducida en...", "Multiplicar por..." };
		cbOpElem = new JComboBox<String>(itemsElem);
		cbOpElem.addItemListener(this);
		txtF1 = new JTextField("0");
		txtF2 = new JTextField("0");
		componente(this, lblOpE, 0, 6, 1, 1, 1.0, 0.5, GridBagConstraints.NONE,
				"");
		...
		try {
			...
			Logger.getLogger(MatricesJApplet.class.getName()).log(Level.SEVERE,
					null, ex);
		}
		...
		itemsMatr = new String[] { "Valor Absoluto", "Adjunta", "Cofactor",
				"Diagonal", "Inversa", "Transpuesta", "Triangular Inferior",
				"Triangular Inferior Estricta", "Triangular Superior",
				"Triangular Superior Estricta" };
		cbOpMatriz = new JComboBox<String>(itemsMatr);
		cbOpMatriz.addItemListener(this);

		componente(this, lblOpM, 0, 9, 1, 1, 1.0, 0.5, GridBagConstraints.NONE,
				"");
		componente(this, cbOpMatriz, 1, 9, 3, 1, 1.0, 0.5,
				GridBagConstraints.HORIZONTAL, "");

		// Matriz resultado
		dtmRes = new javax.swing.table.DefaultTableModel(matriz.abs()
				.getMatriz(), new String[] { "1", "2", "3" });
