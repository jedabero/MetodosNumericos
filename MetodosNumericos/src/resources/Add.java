...
public final class Add {
	 ...
	 * 
	 * @param gbl
	 *            El componente con el GridBagLayout.
	 * @param jc
	 *            El componente a ser anadido.
	 * @param x
	 *            La posicion en columnas del componente. La primera es 0.
	 * @param y
	 *            La posicion en filas del componente. La primera es 0.
	 * @param w
	 *            El numero de columnas que ocupa el componente.
	 * @param h
	 *            El numero de filas que ocupa el componente,
	 * @param wx
	 *            La proporcion de ancho del componente.
	 * @param wy
	 *            La proporcion de alto del componente.
	 * @param f
	 *            Valor que determina como redimensionar el componente.
	 * @param toolTip
	 *            Texto a mostrar en el ToolTip del componente.
	 */
	public static void componente(Container gbl, JComponent jc, int x, int y,
	 ...
	 *            mnemonic del menu
	 * @param types
	 *            tipos de item (item(0) o submenu(1))
	 * @param subTextos
	 *            textos de los items
	 * @param subTTT
	 *            ToolTipText de los items
	 * @param als
	 *            actionListeners de los items
	 * @param mns
	 *            mnemonics de los items
	 * @param subItems
	 *            textos de los subItems
	 * @param states
	...
	public static void menu(JMenuBar jmb, String texto, char mn, int types[],
			...
			String subItems[][], boolean states[][], char subTypes[][]) {
	 ...
	 * 
	 * @param menu
	 *            menu al que se va a agregar el item.
	 * @param texto
	 *            texto que lleva el item.
	 * @param ttt
	 *            ToolTipText
	 * @param al
	 *            listener que se ejecuta al seleccionar el item.
	 * @param mn
	 *            letra mnemotecnica
	 */
	 ...
	 *            letra mnemotecnica
	 * @param subItems
	 *            array con los nombres de cada item
	 * @param states
	 *            array con los estados de cada item
	 * @param types
	 *            array con los tipo de cada item
	 */
	 ...
	 * 
	 * @param jdp
	 *            el DesktopPane al que se anadiran componentes.
	 * @param jc
	 *            el componente a ser anadido.
	 * @param x
	 *            ubicacion en pixeles de derecha a izquierda.
	 * @param y
	 *            ubicacion en pixeles de arriba a abajo.
	 * @param w
	 *            ancho que ocupa el componente.
	 * @param h
	 *            alto que ocupa el componente.
	 */
	public static void aDeskPane(JDesktopPane jdp, JComponent jc, int x, int y,
			int w, int h) {
